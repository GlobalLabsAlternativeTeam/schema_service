...
func (x *GetSchemaByIDRequest) GetSchemaId() int64 {
	if x != nil {
		return x.SchemaId
	}
	return 0
...
func (x *GetSchemaByIDResponse) GetSchemaId() int64 {
	if x != nil {
		return x.SchemaId
	}
	return 0
...
func (x *DeleteSchemaByIDRequest) GetSchemaId() int64 {
	if x != nil {
		return x.SchemaId
	}
	return 0
...
func (x *DeleteSchemaByIDResponse) GetSchemaId() int64 {
	if x != nil {
		return x.SchemaId
	}
	return 0
...
func (x *Schema) GetSchemaId() int64 {
	if x != nil {
		return x.SchemaId
	}
	return 0
...
var file_proto_schema_service_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x6d, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x73,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x49, 0x64, 0x12, 0x37, 0x0a,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x49, 0x64, 0x22, 0x37,
	...
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x49, 0x64, 0x12,
